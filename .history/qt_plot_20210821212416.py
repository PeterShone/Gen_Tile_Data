...
if __name__ == '__main__':
    ...
    data_env.complete_graph.show_complete_super_graph(plotter, debugger, f"{config.env_name}-ring{config.complete_graph_size}-{config.number_of_data}.png")
    plotter.draw_contours(debugger.file_path("proto_tiles.png"), [tile.get_plot_attribute("blue_trans") for tile in data_env.proto_tiles])
